...
document.getElementById("generate-teams").onclick = function() {myFunction()};
...
let val = document.getElementById("team-results").getElementsByTagName("tbody");
for (let i = 0; i < val.length; i++) {
  val[i].innerHTML = "";
}

    let table = document.getElementById("team-results").getElementsByTagName("tbody")[0];
